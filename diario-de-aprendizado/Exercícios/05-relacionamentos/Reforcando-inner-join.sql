...
select avg(anoPublicaçao)from Livros;
  ...
  select nomeAluno,idade,livroFavorito from Alunos as A
  join Livros AS L on A.livroFavorito = L.id;

select nomeAluno, idade, livroFavorito from Alunos
join Livros on Alunos.livroFavorito = Livros.id;
